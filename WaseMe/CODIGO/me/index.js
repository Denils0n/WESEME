...
////////////////////////////////////////////////////////////////////////////////
    ...
    function encontrarCaminho(mapa, posicaoAtual) {
        ...
        if (!localDestino) {
            ...
            log.push(`Posição destino não encontrada.`);
        ...
        while (true) {
            ...
            if (posicaoAtual[0] === localDestino[0] && posicaoAtual[1] === localDestino[1]) {
                ...
                log.push(`Caminho Percorrido: [${caminhoPercorrido}]`);
            ...
            if (!proximaPosicao) {
                ...
                log.push(`Não foi possível encontrar um caminho até o destino.`);
                break;
            }
    ...
    function iniciarRota(){
        ...
        function mover(mapa, caminho) {
            ...
            if (!posicaoAtual) {
                ...
                log.push(`Posição inicial do usuário não encontrada.`);
                return false;
            }
            ...
            function moveParaProximaPosicao() {
                ...
                if (mapa[y][x] >= 1) {
                    ...
                    if (!novoCaminho) {
                        ...
                        log.push(`Não foi possível encontrar um novo caminho.`);

                        return false;
                    }
                    console.log("Novo caminho encontrado:", novoCaminho);
                    log.push(`Novo caminho encontrado: [ ${novoCaminho} ]`);
